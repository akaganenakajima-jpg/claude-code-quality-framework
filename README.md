...
**UI作成のデフォルトスタイル** — 別のスタイルが指定されない限り、自動的に Apple HIG に準拠したデザインを生成します。
UX心理学知識と連携し、「なぜそのデザインが効くか」の心理学的根拠も提供します。

| ファイル | 内容 |
|---------|------|
| `SKILL.md` | スキル定義・デザインシステム仕様・UX心理学連携テーブル |
| `REFERENCE.md` | ページレイアウト・ナビゲーション・フォーム等の実装パターン |
| `design-tokens.css` | CSS変数（SF Pro Typography・System Colors・8pt Grid） |
| `components.jsx` | Reactコンポーネントテンプレート |
| `ui-patterns.md` | UIパターン詳細ドキュメント |
...
│       ├── SKILL.md, REFERENCE.md, LICENSE
│       └── resources/              ← design-tokens.css, components.jsx, ui-patterns.md
├── hooks/
